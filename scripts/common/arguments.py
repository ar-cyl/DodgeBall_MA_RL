...
def get_args():
    ...
    parser.add_argument("--noise_rate", type=float, default=1.0, help="noise rate for sampling from a standard normal distribution ")
    ...
    parser.add_argument("--batch-size", type=int, default=2000, help="number of episodes to optimize at the same time")
    ...
    #self-play
    parser.add_argument("--size_netbank", type=int, default=100, help="number of past actor networks to save")
    parser.add_argument("--swap_team", type=int, default=120000, help="after this many steps, change the policy of opponent team")
