...
def get_args():
    ...
    #self-play
    parser.add_argument("--size_netbank", type=int, default=10, help="number of past actor networks to save")
    parser.add_argument("--swap_team", type=int, default=20000, help="after this many steps, change the policy of opponent team")
